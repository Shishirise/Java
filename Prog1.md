```java
//Shishir Adhikari
//CMPS-4143-102 Tina Johnson
// Description : In this program we are going to find the soultions of quadratic equations using formula.


//Import the necessary classes(input)
import java.util.*;
    ...
    public static void main(String[] args) {
        ...
        //Print the statement where user enters the value for coefficients
         while(true){
            ...
            // Using if statement to qutting the program( if a,b,c= 0,0,0)
